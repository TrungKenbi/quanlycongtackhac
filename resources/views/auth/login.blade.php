...
<head>
    ...
    <title>Đăng Nhập - Quản Lý Công Tác Khác</title>
    <!-- Custom CSS -->
                    ...
                    <div class="row p-b-30">
                        <div class="col-12">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg" placeholder="Tài khoản" aria-label="Tài khoản" aria-describedby="basic-addon1" name="email" value="{{ old('email') }}" required="">
                            </div>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text bg-warning text-white" id="basic-addon2"><i class="ti-pencil"></i></span>
                                </div>
                                <input type="password" class="form-control form-control-lg" placeholder="Mật khẩu" aria-label="Mật khẩu" aria-describedby="basic-addon1" name="password" required="">
                            </div>
